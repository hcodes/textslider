$(function() {
    ...
    $('input.angle', context).textSlider({
        min: 0,
        max: 360,
        filterForValue: function (value, data) {
    ...
    $('input.month', context).textSlider({
        min: 1,
        max: 12,
        filterForValue: function(value, data) {
            var months = [
            ...
            var t = months[parseInt(value, 10) - 1];
            data.span.css({
                color: t.color,
                borderColor: t.color
            });
    ...
    $('input.width, input.height', context).textSlider({
        min: 10,
        max: 90,
        filterForCSS: function (value, data) {
            var obj = {},
